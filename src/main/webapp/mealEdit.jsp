...
<hr>
<h2>Edit meal</h2>
<form id="edit" method="post" action="meals" enctype="application/x-www-form-urlencoded">
    ...
    <dl>
        <dt>Calories:</dt>
        <dd><label><input required type="text" name="calories" size=30 value="${meal.calories}"></label></dd>
    </dl>
