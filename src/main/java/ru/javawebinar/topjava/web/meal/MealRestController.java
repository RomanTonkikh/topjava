...
public class MealRestController {
    ...
    public List<MealTo> getDateTimeBetween(LocalDate startDate, LocalTime startTime, LocalDate endDate, LocalTime endTime) {
        int userId = SecurityUtil.authUserId();
        log.info("user {} / date {} - {} / time {} - {}", userId, startDate, endDate, startTime, endTime);
